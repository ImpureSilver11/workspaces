...
module Book
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['BOOK_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Book::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Book::Action is included
      ...
      # Configure the code that will yield each time Book::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Book::Assets::Helpers
      end
    end
